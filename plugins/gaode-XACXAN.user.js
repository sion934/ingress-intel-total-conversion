...
// @name           IITC plugin: 高德地图 Updated by XACXAN
// @category       Map Tiles
// @version        0.0.1.20180210.2242
// @namespace      https://github.com/jonatkins/ingress-intel-total-conversion
// @updateURL      http://whres.net/gaode-XACXAN.user.js
// @downloadURL    http://whres.net/gaode-XACXAN.user.js
// @description    更新时间：2018年2月10日，更新地图为最新版高德地图，计划增加高德HTTPS连接
// @author         XACXAN
...
window.plugin.mapGaode.setup = function() {
    ...
    var gaodeSat = L.gaodeLayer('http://wprd0{s}.is.autonavi.com/appmaptile?lang=zh_cn&style=6&x={x}&y={y}&z={z}', {type: 'SATELLITE'});
    layerChooser.addBaseLayer(gaodeSat, '高德地图卫星 by XACXAN');

    var gaodeRoad = L.gaodeLayer('http://wprd0{s}.is.autonavi.com/appmaptile?lang=zh_cn&style=7&x={x}&y={y}&z={z}', {type: 'ROADS'});
    layerChooser.addBaseLayer(gaodeRoad, '高德地图道路 by XACXAN');

    var gaodeHybrid = L.layerGroup([
        L.gaodeLayer('http://wprd0{s}.is.autonavi.com/appmaptile?lang=zh_cn&style=6&x={x}&y={y}&z={z}', {type: 'SATELLITE'}),
